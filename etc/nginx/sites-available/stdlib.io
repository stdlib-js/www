...
server {
  ...
  location ~* ^/e/[a-z0-9.\-_]+ {
    # Rewrite (and redirect) error decoder requests to the corresponding API docs location.
    #
    # ## Usage
    #
  ...
  # Define a location directive for resolving the developer documentation server status:
  location = /docs/dev/status {
    # Set proxy headers passed to the proxied server.
    #
    # ## Usage
    #
    ...
    #
    # [1]: https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_pass
    proxy_pass http://127.0.0.1:3002/status;
  }

  # Define a location directive for pinging the developer documentation server:
  location = /docs/dev/ping {
    # Set proxy headers passed to the proxied server.
    #
    # ## Usage
    #
    ...
    #
    # [1]: https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_pass
    proxy_pass http://127.0.0.1:3002/ping;
  }

  # Define a location directive for serving developer documentation:
  location ~* ^/docs/dev/[a-z0-9.\-_]+/ {
    # Set proxy headers passed to the proxied server.
    #
    # ## Usage
    #
  ...
  # Define a location directive for resolving the developer documentation landing page:
  location /docs/dev {
    # Set proxy headers passed to the proxied server.
    #
    # ## Usage
    ...
    #
    # [1]: https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_pass
    proxy_pass http://127.0.0.1:3000/docs/dev;
  }
