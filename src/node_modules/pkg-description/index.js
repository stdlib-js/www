...
var pkgDescriptions = require( 'pkg-descriptions' );
var pkgOrder = require( 'pkg-order' );
...
*/
function description( pkg, version ) {
	var order;
	var desc;

	desc = pkgDescriptions( version );
	if ( desc === null ) {
		return null;
	}
	order = pkgOrder( version );
	if ( order === null ) {
		return null;
	}
