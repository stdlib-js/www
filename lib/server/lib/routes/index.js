...
var errorDecode = require( './error/decode' );
var errorMessage = require( './error/message' );
var version = require( './version' );
var landing = require( './landing' );
var search = require( './search' );
var pkgs = require( './packages' );
...
var docsVersions = require( './docs/versions' );
var docsProxy = require( './docs/proxy' );
...
function register( fastify, options, done ) {
	...
	fastify.route( errorDecode() );               // /docs/api/:version/error/decoder/:code
	fastify.route( errorMessage() );              // /docs/api/:version/error/message/:code
	...
	fastify.route( pkgs() );                      // /docs/api/:version/@stdlib/*

	// Documentation versions:
	fastify.route( docsVersions() );              // /docs/versions.json

	// Documentation proxy (must be last to not intercept other /docs/* routes):
	fastify.route( docsProxy() );                 // /docs/*
